...
const (
	...
	cpuDockerfileTemplate = `# Generated by gen-builder
...
`
	...
	gpuDockerfileTemplate = `# Generated by gen-builder
# Configuration: {{ .Description }}
...
func GenerateDockerfile(baseImage string, cozyConfig *ToolsCozyConfig) (string, error) {
	...
	data := DockerfileData{
		BaseImage:   baseImage,
		Predict:     cozyConfig.Predict,
		ModuleName:  cozyConfig.Name,
